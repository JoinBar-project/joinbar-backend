...
// 每間酒吧的標籤組合
const BAR_TAGS: Record<string, Partial<Record<
  'sport' | 'music' | 'student' | 'bistro' | 'drink' | 'joy' | 'romantic' | 'oldschool' | 'highlevel' | 'easy',
  boolean
>>> = {
  'Draft Land':          { music: true, drink: true, joy: true, easy: true },
  'Bar Mood Taipei':     { music: true, romantic: true, highlevel: true },
  'Indulge Bistro':      { bistro: true, romantic: true, highlevel: true, easy: true },
...
const DEFAULT_TAG = {
  sport: false, music: false, student: false, bistro: false, drink: false,
  joy: false, romantic: false, oldschool: false, highlevel: false, easy: false,
};
